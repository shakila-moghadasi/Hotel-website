(function ($) {
    ...
    $.fn.slicarousel = function (options) {
        ...
        if (params.arrows) {
            let next = '<svg version="1.1" xmlns="https://hotel-xenia.plethorathemes.com/wp-content/themes/hotel-xenia/assets/images/slider-arrows.png" viewBox="0 0 129 129" xmlns:xlink="https://hotel-xenia.plethorathemes.com/wp-content/themes/hotel-xenia/assets/images/slider-arrows.png" enable-background="new 0 0 129 129"> <g> <g> <path d="M64.5,122.6c32,0,58.1-26,58.1-58.1S96.5,6.4,64.5,6.4S6.4,32.5,6.4,64.5S32.5,122.6,64.5,122.6z M64.5,14.6 c27.5,0,49.9,22.4,49.9,49.9S92,114.4,64.5,114.4S14.6,92,14.6,64.5S37,14.6,64.5,14.6z"/> <path d="m51.1,93.5c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4 2.9-1.2l26.4-26.4c0.8-0.8 1.2-1.8 1.2-2.9 0-1.1-0.4-2.1-1.2-2.9l-26.4-26.4c-1.6-1.6-4.2-1.6-5.8,0-1.6,1.6-1.6,4.2 0,5.8l23.5,23.5-23.5,23.5c-1.6,1.6-1.6,4.2 0,5.8z"/> </g> </g></svg>'
            let prev = '<svg version="1.1" xmlns="https://hotel-xenia.plethorathemes.com/wp-content/themes/hotel-xenia/assets/images/slider-arrows.png" viewBox="0 0 129 129" xmlns:xlink="https://hotel-xenia.plethorathemes.com/wp-content/themes/hotel-xenia/assets/images/slider-arrows.png" enable-background="new 0 0 129 129"> <g> <g> <path d="m64.5,122.6c32,0 58.1-26 58.1-58.1s-26-58-58.1-58-58,26-58,58 26,58.1 58,58.1zm0-108c27.5,5.32907e-15 49.9,22.4 49.9,49.9s-22.4,49.9-49.9,49.9-49.9-22.4-49.9-49.9 22.4-49.9 49.9-49.9z"/> <path d="m70,93.5c0.8,0.8 1.8,1.2 2.9,1.2 1,0 2.1-0.4 2.9-1.2 1.6-1.6 1.6-4.2 0-5.8l-23.5-23.5 23.5-23.5c1.6-1.6 1.6-4.2 0-5.8s-4.2-1.6-5.8,0l-26.4,26.4c-0.8,0.8-1.2,1.8-1.2,2.9s0.4,2.1 1.2,2.9l26.4,26.4z"/> </g> </g></svg>'
            // let next = ''
            // let prev = ''
